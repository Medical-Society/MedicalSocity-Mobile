...
const ProfileIcon = React.memo(({ width, height, focused }) => {
  return (
...
const NotificationIcon = React.memo(({ width, height, focused }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 32 32" fill="none">
...
const HomeIcon = React.memo(({ width, height, focused }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 32 32" fill="none">
      <ClipPath id="clip-path">
        <Rect width="31.8971" height="31.8971" fill="#D9D9D9" />
...
const CalenderIcon = React.memo(({ width, height, focused }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 32 32" fill="none">
      <ClipPath id="clip-path">
        <Rect width="31.8971" height="31.8971" fill="#D9D9D9" />
    ...
    >
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            <NotificationIcon width={35} height={35} focused={focused} />
          ),
          tabBarIconStyle: {
            marginBottom: Platform.OS === "ios" ? 20 : 0,
          },
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            <CalenderIcon width={35} height={35} focused={focused} />
          ),
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            <HomeIcon width={35} height={35} focused={focused} />
          ),
